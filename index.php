...
// PRIVATE CHAT START
        case "private":
            ...
            case Emoticon::globe().$lang->menu->changeLanguage:
                $messageManager->sendChatAction($user->getChat()->getId(), "typing");
                try {
                    $user->setCurrentOperation(CHANGE_LANGUAGE);
                    $userController->updateCurrentOperation($user);
            ...
            case "en":
                try {
                    ...
                    } else if ($operation == CHANGE_LANGUAGE) {
            ...
            case Emoticon::group().$lang->menu->yourGroups:
                ...
                try {
                    ...
                    if (sizeof($myGroups) > 0) {
                        ...
                        $text = $user->getName()." ".$lang->ui->notInGroupTogether.Emoticon::smile();
...
//                                    }
                        ...
                        case Emoticon::right().$lang->menu->nextStep:
                            try {
                                $messageManager->sendChatAction($user->getChat()->getId(), "typing");
//                                $configuration = $groupController->checkConfiguration($user->getChat());
//                                $conf = false;
//                                while (!$conf) {
